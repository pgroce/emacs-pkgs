...
#+begin_src emacs-lisp
  ...
  ;;;; of these functions. Similarly, they only activate or deactivate a
  ;;;; venv; lifecycle management (e.g., calling (deactivate) before
  ;;;; calling (activate) when changing between venvs) is not in scope
