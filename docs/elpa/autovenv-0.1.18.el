...
unset."
  ...
  (when (called-interactively-p 'interactive)
    (if (not (null autovenv--venv))
        (message "autovenv: Current virtualenv is '%s'" autovenv--venv)
      (message "autovenv: Virtualenv is unset")))
  autovenv--venv)
...
(defun autovenv-get-python-version ()
  ...
  (interactive)
  (when (called-interactively-p 'interactive)
    (if (not (null autovenv--python-version))
        (message "autovenv: Python version is '%s'" autovenv--python-version)
      (message "autovenv: Python version is unset")))
  autovenv--python-version)
